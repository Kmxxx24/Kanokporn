...
WebUI.setText(findTestObject('Page_Demo Site  Registration Form  NxtGen A_68ffcd/input_City_vfb-13state'), 'นครปฐม')
...
WebUI.setText(findTestObject('Object Repository/Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-14'), '644259001@webmail.npru.ac.th')
...
WebUI.setText(findTestObject('Page_Demo Site  Registration Form  NxtGen A_68ffcd/textarea_Enter your query_vfb-23'), 'no')

WebUI.setText(findTestObject('Object Repository/Page_Demo Site  Registration Form  NxtGen A_68ffcd/input__vfb-3'), '99')

WebUI.click(findTestObject('Page_Demo Site  Registration Form  NxtGen A_68ffcd/input_This box is for spam protection - str_2dcb9b'))
